...
class Curve:
    ...
    def _interpolateRate(self, t):
        return max(0.0, self.interpolator.interpolate(t))
    
    def _interpolateDf(self, t):
        return min(1.0, self.interpolator.interpolate(t))
    ...
    def DfFromZc(zc, time):
        return (1 + zc) ** -time if zc > 0 else 1.0
