...
test.execute = function (TestFramework, JsonRisk) {
    ...
    for (i = 0; i < 400; i++) {
        ...
        TestFramework.assert((p1 > 100 && p2 < 100), "Irregular bond valuation for amortising bonds (" + (i + 1) + ").");
    }
    ...
    for (i = 0; i < 400; i++) {
        ...
        console.log("JSON Risk irregular bond price discounted at coupon rate plus one basis point (" + (i + 1) + "): " + p2.toFixed(3));
        TestFramework.assert((p1 > 100 && p2 < 100), "Irregular bond valuation with changing repay amounts (" + (i + 1) + ").");
    }
    ...
    for (i = 0; i < 400; i++) {
        ...
        TestFramework.assert((res < 0.001), "Irregular bond valuation with margin (" + (i + 1) + ").");
    }
    ...
    for (i = 0; i < 400; i++) {
        ...
        TestFramework.assert((p1.toFixed(3) === "100.000"), "Fair rate derivation for amortising fixed rate bonds (" + (i + 1) + ").");
        ...
        TestFramework.assert((p1.toFixed(3) === "100.000"), "Fair spread derivation for amortising float rate bonds (" + (i + 1) + ").");
    }
