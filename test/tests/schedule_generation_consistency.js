...
test.execute = function (TestFramework, JsonRisk) {
    ...
    for (i = 2; i <= 12; i++) {
        ...
        TestFramework.assert_same_dates(sched, expected,
        ...
        TestFramework.assert_same_dates(sched, expected, "Schedule generation consistency long stub at beginning (" + (i - 1) + ")");
        ...
        TestFramework.assert_same_dates(sched, expected, "Schedule generation consistency short stub at end (" + (i - 1) + ")");
        ...
        sched = JsonRisk.schedule(start, end, i, adj, null, stub, null, null);
        TestFramework.assert_same_dates(sched, expected, "Schedule generation consistency long stub at end (" + (i - 1) + ")");
    }
