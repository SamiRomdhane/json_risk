...
var quotes = [-0.006, -0.004, -0.003, -0.002, 0.001, 0.011];
...
JR.find_root_secant(
  func_price, // function to find root for
  1, // start value 1
  0.9, // start value 2
  10, // max iterations
  1e-12, //accuracy
...
console.log(
  "Deposit price   t0: " +
    (1 - JR.pricer_bond(instruments[0], curve)).toFixed(10),
);
...
for (var i = 1; i < quotes.length; i++) {
  ...
  console.log(
    "Swap price      t" +
      i +
      ": " +
      JR.pricer_swap(instruments[i], curve, curve).toFixed(10),
  );
}
