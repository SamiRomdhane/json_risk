      ...
      https
        .get(input.paramsurl.url, (resp) => {
          ...
          resp.on("end", () => {
            ...
            res = calculation(
              params_global[input.paramsurl.url],
              input.portfolio,
            );
